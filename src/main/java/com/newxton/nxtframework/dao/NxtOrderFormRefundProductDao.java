...
public interface NxtOrderFormRefundProductDao {
     ...
     *
     * @param entities List<NxtOrderFormRefundProduct> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<NxtOrderFormRefundProduct> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<NxtOrderFormRefundProduct> entities);
