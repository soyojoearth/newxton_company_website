...
public interface NxtOrderFormRefundLogDao {
     ...
     *
     * @param entities List<NxtOrderFormRefundLog> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<NxtOrderFormRefundLog> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<NxtOrderFormRefundLog> entities);
