...
public interface NxtCommissionDao {
     ...
     *
     * @param entities List<NxtCommission> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<NxtCommission> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<NxtCommission> entities);
