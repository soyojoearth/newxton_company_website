 ...
 */
@Component
public class NxtProductSpiderAmazonComponent implements NxtComponentInterfaceProductSpider {

    private Logger logger = LoggerFactory.getLogger(NxtProductSpiderAmazonComponent.class);
    ...
    public Boolean isMatchUrl(String url){
        if (url.toLowerCase().contains("amazon.com")){
            return true;
        }
        return false;
    }
