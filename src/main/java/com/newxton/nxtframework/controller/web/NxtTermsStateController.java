...
//        if (device.isMobile()){
//            model.setViewName("mobile/"+nxtSaaSCoreComponent.findTenantTempleteMobile()+"/terms_state");
////            logger.info("移动端访客");
//        }
//        else {
            model.setViewName("pc/"+nxtSaaSCoreComponent.findTenantTempletePc()+"/terms_state");
//            logger.info("PC端访客");
//        }
