...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_action` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `action_class_UNIQUE` (`tenant_id` ASC, `action_class` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 61
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_group` (
  ...
  `tenant_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `group_name_UNIQUE` (`tenant_id` ASC, `group_name` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 16
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_group_action` (
  ...
  UNIQUE INDEX `unique_group_action` (`tenant_id` ASC, `group_id` ASC, `action_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 86
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_role` (
  ...
  `tenant_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `role_name_UNIQUE` (`tenant_id` ASC, `role_name` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 8
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_role_group` (
  ...
  UNIQUE INDEX `unique_role_group` (`tenant_id` ASC, `role_id` ASC, `group_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 28
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_user` (
  ...
  `tenant_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `username_UNIQUE` (`tenant_id` ASC, `username` ASC),
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_user_action` (
  ...
  UNIQUE INDEX `unique_user_action` (`tenant_id` ASC, `user_id` ASC, `action_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_acl_user_role` (
  ...
  UNIQUE INDEX `unique_user_role` (`tenant_id` ASC, `user_id` ASC, `role_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 19
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_setting` (
  ...
  `tenant_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `setting_key_UNIQUE` (`tenant_id` ASC, `setting_key` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 11
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_web_page` (
  ...
  `tenant_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `unique_web_key` (`tenant_id` ASC, `web_key` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 5
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_delivery_config_item_region` (
  ...
  UNIQUE INDEX `unique_item_region` (`tenant_id` ASC, `delivery_config_item_id` ASC, `delivery_region_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_product_sku_value_price_etc` (
  ...
  UNIQUE INDEX `unique_value_id` (`tenant_id` ASC, `sku_value_id_1` ASC, `sku_value_id_2` ASC),
...
CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_order_form_refund_delivery` (
  ...
  UNIQUE INDEX `order_form_refund_id_UNIQUE` (`tenant_id` ASC, `order_form_refund_id` ASC),
  INDEX `index_tenant_id` (`tenant_id` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `nxtframework`.`nxt_tenant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxtframework`.`nxt_tenant` ;

CREATE TABLE IF NOT EXISTS `nxtframework`.`nxt_tenant` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `domains` TEXT NOT NULL,
  `tenant_name` VARCHAR(255) NULL,
  `templete_pc` VARCHAR(255) NULL COMMENT 'Pc端模版名称',
  `templete_mobile` VARCHAR(255) NULL COMMENT '移动端模版名称',
  `remark` TEXT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
