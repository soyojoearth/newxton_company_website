...
CREATE TABLE IF NOT EXISTS `nxt_acl_action` (
...
CREATE TABLE IF NOT EXISTS `nxt_acl_group` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_acl_group_action` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_acl_role` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_acl_role_group` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_uploadfile_category` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_uploadfile` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_acl_user_action` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `nxt_acl_user_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_acl_user_role` ;

CREATE TABLE IF NOT EXISTS `nxt_acl_user_role` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `user_id` BIGINT(20) NOT NULL,
  `role_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `nxt_banner` (
...
-- -----------------------------------------------------
-- Table `nxt_news_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_news_category` ;

CREATE TABLE IF NOT EXISTS `nxt_news_category` (
...
CREATE TABLE IF NOT EXISTS `nxt_content` (
...
CREATE TABLE IF NOT EXISTS `nxt_cronjob` (
...
CREATE TABLE IF NOT EXISTS `nxt_guestmessage` (
...
-- -----------------------------------------------------
-- Table `nxt_product_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_product_category` ;

CREATE TABLE IF NOT EXISTS `nxt_product_category` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `category_name` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL COMMENT '分类名称',
  `category_pid` BIGINT(20) NULL DEFAULT NULL COMMENT '上级分类id',
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_product_brand` ;

CREATE TABLE IF NOT EXISTS `nxt_product_brand` (
...
CREATE TABLE IF NOT EXISTS `nxt_product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  ...
  `unit_weight` BIGINT(20) NULL COMMENT '重量（单位：克）',
  `unit_volume` BIGINT(20) NULL COMMENT '体积（单位：立方米）放大100万倍',
...
CREATE TABLE IF NOT EXISTS `nxt_product_picture` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_product_sku` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `product_id` BIGINT(20) NOT NULL COMMENT '产品ID',
...
CREATE TABLE IF NOT EXISTS `nxt_product_sku_value` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nxt_setting` (
...
CREATE TABLE IF NOT EXISTS `nxt_web_page` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_delivery_region` ;

CREATE TABLE IF NOT EXISTS `nxt_delivery_region` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_delivery_config` ;

CREATE TABLE IF NOT EXISTS `nxt_delivery_config` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_delivery_config_item` ;

CREATE TABLE IF NOT EXISTS `nxt_delivery_config_item` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_delivery_config_item_region` ;

CREATE TABLE IF NOT EXISTS `nxt_delivery_config_item_region` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_delivery_company` ;

CREATE TABLE IF NOT EXISTS `nxt_delivery_company` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_product_sku_value_price_etc` ;

CREATE TABLE IF NOT EXISTS `nxt_product_sku_value_price_etc` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form` (
  ...
  `delivery_config_name` VARCHAR(255) NOT NULL COMMENT '运费模版名称',
  `delivery_cost` BIGINT(20) NOT NULL COMMENT '运费',
  `count_weight` BIGINT(20) NULL COMMENT '单位（克）',
  `count_volume` BIGINT(20) NULL COMMENT '单位（立方米）放大100万倍',
  `status_paid` INT(11) NOT NULL COMMENT '是否已经支付（0：未支付 1:已支付）（支付失败的还是0）',
...
-- -----------------------------------------------------
-- Table `nxt_transaction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_transaction` ;

CREATE TABLE IF NOT EXISTS `nxt_transaction` (
...
-- -----------------------------------------------------
-- Table `nxt_order_form_pay`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_pay` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_pay` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_product` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_product` (
  ...
  `unit_weight` BIGINT(20) NULL COMMENT '单位（克）',
  `unit_volume` BIGINT(20) NULL COMMENT '单位（立法米）放大100万倍',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_refund` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_refund` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `order_form_id` BIGINT(20) NOT NULL,
  `reason_type` INT NOT NULL COMMENT '0:无理由 1:质量问题',
  `reasion_description` TEXT NULL COMMENT '退货原因描述',
  `transaction_id` BIGINT(20) NULL,
  `status` BIGINT(20) NULL COMMENT '状态（-1:拒绝退款 0:已申请 1:完成 2:等用户发货 3:收到货退款 4:收到货有问题，请修改金额）',
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `nxt_order_form_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_log` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_log` (
...
-- -----------------------------------------------------
-- Table `nxt_order_form_delivery`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_delivery` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_delivery` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '订单物流表',
  `type` INT(11) NOT NULL COMMENT '类型（1:发货 -1:退货）',
  `order_form_id` BIGINT(20) NOT NULL,
...
-- Table `nxt_recharge`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_recharge` ;

CREATE TABLE IF NOT EXISTS `nxt_recharge` (
  ...
  `dateline` VARCHAR(45) NOT NULL COMMENT '时间',
...
-- Table `nxt_withdraw`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_withdraw` ;

CREATE TABLE IF NOT EXISTS `nxt_withdraw` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '提现表',
  `user_id` BIGINT(20) NOT NULL,
  `transaction_id` BIGINT(20) NOT NULL,
  `status` INT(11) NOT NULL COMMENT '状态（0:已申请 1:已批准 2:已拒绝&退还 3:已汇款）',
  `type` INT(11) NOT NULL COMMENT '提现类型（1:提现 -1:拒绝后撤销提现）',
  `amount` BIGINT(20) NOT NULL COMMENT '正数：提现 负数：撤销提现',
  `dateline_create` BIGINT(20) NOT NULL,
  `dateline_end` VARCHAR(45) NULL,
  `platform` INT(11) NOT NULL COMMENT '平台（0:银行 1:微信 2:支付宝 3:paypal 888:现金）',
...
-- -----------------------------------------------------
-- Table `nxt_commission_transfer_in`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_commission_transfer_in` ;

CREATE TABLE IF NOT EXISTS `nxt_commission_transfer_in` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_commission` ;

CREATE TABLE IF NOT EXISTS `nxt_commission` (
...
-- Table `nxt_reviews`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_reviews` ;

CREATE TABLE IF NOT EXISTS `nxt_reviews` (
...
-- -----------------------------------------------------
-- Table `nxt_reviews_picture`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_reviews_picture` ;

CREATE TABLE IF NOT EXISTS `nxt_reviews_picture` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_user_address` ;

CREATE TABLE IF NOT EXISTS `nxt_user_address` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '收货地址',
  `user_id` BIGINT(20) NOT NULL,
  `region_level_0` BIGINT(20) NULL,
  `region_level_1` BIGINT(20) NULL,
  `region_level_2` BIGINT(20) NULL,
  `region_level_3` BIGINT(20) NULL,
  `region_level_4` BIGINT(20) NULL,
  `region_address` VARCHAR(255) NULL,
...
-- -----------------------------------------------------
-- Table `nxt_user_level`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_user_level` ;

CREATE TABLE IF NOT EXISTS `nxt_user_level` (
...
-- -----------------------------------------------------
-- Table `nxt_order_form_refund_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_refund_log` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_refund_log` (
...
-- -----------------------------------------------------
-- Table `nxt_order_form_refund_picture`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_refund_picture` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_refund_picture` (
...
-- -----------------------------------------------------
-- Table `nxt_order_form_refund_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_order_form_refund_product` ;

CREATE TABLE IF NOT EXISTS `nxt_order_form_refund_product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `order_form_product_id` BIGINT(20) NOT NULL,
  `order_form_refund_id` BIGINT(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `nxt_shopping_cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_shopping_cart` ;

CREATE TABLE IF NOT EXISTS `nxt_shopping_cart` (
...
-- -----------------------------------------------------
-- Table `nxt_shopping_cart_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nxt_shopping_cart_product` ;

CREATE TABLE IF NOT EXISTS `nxt_shopping_cart_product` (
  ...
  `checked` INT NOT NULL COMMENT '是否选中（0:否 1:是）',
  PRIMARY KEY (`id`),
